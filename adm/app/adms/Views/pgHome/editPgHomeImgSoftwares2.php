...
<div class="container">
	 <div class="d-flex">
        <div class="mr-auto p-2">
            <h2>Editar Imagem da Ferramenta 2</h2>
            <a name="ferramenta_1">
        </div>
        <div class="p-2">
			...
			<form method="POST" action="" enctype="multipart/form-data">
				<input name="id" type="hidden" id="id" value='<?php 
		            	...
		            	?>'>
				<input name="icone_soft_2" type="hidden" id="icone_soft_2" value='<?php 
		            	if($valorForm['icone_soft_2']) { 
		            		echo $valorForm['icone_soft_2']; 
		            	}
		            	?>'>
	        	<div class="form-group">
		            <label for="img_nova">Imagem Ferramenta 2</label>
	        	...
	        	<div class="form-group">
	        		<?php 
		            	if($valorForm['icone_soft_2']) { 
		            		$img_antiga = $valorForm['icone_soft_2']; 
		            	}
		            	?>
	        	...
	        	<input name="EditSoftImg2" id="bt-salvar" type="submit" class="btn btn-primary" value="Salvar" class="btn" disabled="true>
			</form>
</div>
<hr>
